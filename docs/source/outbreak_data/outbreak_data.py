...
def prevalence_by_location(location, ndays=2048, nday_threshold=0, other_threshold=0, other_exclude=None, cumulative=None, server=server, auth=None, startswith=None):
    ...
    Arguments:
     ...
     :ndays (Default: 2048) The number of days before the current date to be used as a window to accumulate linegaes under "Other".
     ...
     :startswith: A string; loads data for all lineages beginning with first letter(s) of name
     :return: A pandas 
    """
